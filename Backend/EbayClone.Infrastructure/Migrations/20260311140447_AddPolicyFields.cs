...
{
    /// <inheritdoc />
    public partial class AddPolicyFields : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttributeHints = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "SELLER"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalShippingPolicies = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    TotalReturnPolicies = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    MonthlyListingLimit = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "PENDING_PAYMENT"),
                    ...
                    ReceiverInfo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDomesticAccepted = table.Column<bool>(type: "bit", nullable: false),
                    DomesticReturnDays = table.Column<int>(type: "int", nullable: false),
                    DomesticShippingPaidBy = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IsInternationalAccepted = table.Column<bool>(type: "bit", nullable: false),
                    InternationalReturnDays = table.Column<int>(type: "int", nullable: false),
                    InternationalShippingPaidBy = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerWallets", x => x.ShopId);
                    table.ForeignKey(
                        name: "FK_SellerWallets_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    HandlingTimeDays = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopAnalyticsDaily", x => new { x.ShopId, x.ReportDate });
                    table.ForeignKey(
                        name: "FK_ShopAnalyticsDaily_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingPolicyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ReturnPolicyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_ReturnPolicies_ReturnPolicyId",
                        column: x => x.ReturnPolicyId,
                        principalTable: "ReturnPolicies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_ShippingPolicies_ShippingPolicyId",
                        column: x => x.ShippingPolicyId,
                        principalTable: "ShippingPolicies",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableStock = table.Column<int>(type: "int", nullable: false, computedColumnSql: "[Quantity] - [ReservedQuantity]", stored: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ViewerIP = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ViewedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductViewLogs", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductViewLogs_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalLineAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "[Quantity] * [PriceAtPurchase]", stored: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ScheduledAt",
                table: "Products",
                column: "ScheduledAt");

            migrationBuilder.CreateIndex(
                name: "IX_Products_ShippingPolicyId",
                table: "Products",
                column: "ShippingPolicyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductViewLogs_ProductId",
                table: "ProductViewLogs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductViewLogs_ShopId",
                table: "ProductViewLogs",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnPolicies_ShopId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingPolicies_ShopId",
